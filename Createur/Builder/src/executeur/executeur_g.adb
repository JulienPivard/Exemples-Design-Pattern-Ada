...
package body Executeur_G is
   ...
   begin
      W_W_IO_R.Put (W_W_IO_R.Standard_Error, "Usage : ");
      Ada.Text_IO.Put
         (
            Ada.Text_IO.Standard_Error,
            Ada.Directories.Base_Name (Ada.Command_Line.Command_Name)
         );
      W_W_IO_R.Put_Line (W_W_IO_R.Standard_Error, " [arguments]");
      W_W_IO_R.Put_Line (W_W_IO_R.Standard_Error, Indentation);
      --  W_W_IO_R.New_Line (W_W_IO_R.Standard_Error, 1);
   end Afficher_Aide;
   ---------------------------------------------------------------------------
